...
my $class = 'App::Goto::Dir::Data::ValueType::Relations';

use_ok( $class );

my $obj = App::Goto::Dir::Data::ValueType::Relations->new();
...
my $nobj = App::Goto::Dir::Data::ValueType::Relations->restate( $state );
